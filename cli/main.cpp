...
int main(int argc, char *argv[])
{
    ...
    options.add_options()                                                                                                                                                                                                                                                        //
        ...
        ("b,bit", "Write/read the binary file in 32-bit or 64-bit (32 for 32-bit, 64 for 64-bit). If in write mode, use 64-bit if you want to pack files larger than 4GB as long as your filesystem supports 64-bit file", cxxopts::value<std::string>()->default_value("32")) // Write bit mode
        ("o,read-output-path", "Path of the output file if you want to output the bytes being read from the binary file to disk, not to stdout (used in read mode)", cxxopts::value<std::string>())                                                                                    // Write bytes read from the binary file to a file
